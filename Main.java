...
{ 
 ...
 { 
    ...
    { 
        ...
        text1.setText(""); 
        text2.setText(""); 
        JOptionPane.showMessageDialog(this, "Shortusername" , " Packer Unpacker" , JOptionPane.ERROR_MESSAGE); 
        } 
        if (value1.equals("AdminPackUnpack") && value2.equals("AdminPackUnpack"))
        { 
